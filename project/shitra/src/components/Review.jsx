...
import woman1 from '../assets/img/overall/woman1.jpg'
import woman2 from '../assets/img/overall/woman2.jpg'
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold">
            What people Think <span className="text-backgroundColor2">About Us</span>
          </h2>
        </div>
        <div className="flex justify-center space-x-4 mb-8">
          <button className="p-2 rounded-full bg-backgroundColor shadow-md hover:bg-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-backgroundColor p-6 rounded-lg shadow-lg">
